...
const INTENTS: Intent[] = [
  ...
  },
  {
    ...
    response:
      "The Daily and Unique Orthodontic Techniques course now has a revised fee: $399 online / $599 in-person (regular $999) — that's up to $400 off. Prices exclude 13% HST, added at checkout.\n\nSecure your spot:\ncanadent.net/courses/daily-unique-orthodontic-techniques",
  },
  {
