...
export const courses: Course[] = [
  {
    ...
    price: 600,
    priceOptions: [
      { label: "Online Attendance", price: 600 },
      { label: "In-Person Attendance", price: 799 },
    ],
  ...
  {
    slug: "composite-ceramic-inlay-onlay",
    title: "Composite & Ceramic Inlay & Onlay (Direct & Indirect)",
    subtitle: "Lecture, Demo, and Hands-On",
    instructor: "Dr. Ebrahim Aminsalehi, DDS, MS in Operative & Restorative Dentistry",
    price: 695,
    date: "July 25, 2021",
    ...
    status: "sold-out",
    category: "Restorative Dentistry",
    format: "Lecture + Demo + Hands-On",
    image: "/course-inlay-onlay-aminsalehi.png",
    description:
      "A full-day hands-on program covering direct and indirect composite and ceramic inlay and onlay restorations. Dr. Ebrahim Aminsalehi — a specialist in Operative and Restorative Dentistry — guides participants through the clinical rationale, preparation design, material selection, and placement techniques for both composite and ceramic options.",
    highlights: [
      "Direct vs. indirect inlay and onlay decision-making",
      "Preparation design for composite and ceramic restorations",
      "Material selection: composite vs. ceramic",
      "Live demonstration and hands-on practice",
      "7 CE Credits (Category 2, PACE Approved)",
    ],
  },
  {
    slug: "dionavi-full-arch-surgery-process",
    title: "DIONavi. Full Arch Surgery Process",
    subtitle: "Lecture, Demo and Hands-On",
    ...
    time: "9:00 AM – 5:00 PM",
    duration: "Full Day",
    location: "ConfiDentist",
    ceCredits: "7 CE Credits",
    status: "sold-out",
    category: "Implant Dentistry",
    format: "Lecture + Demo + Hands-On",
    image: "/course-dionavi-full-arch.png",
    description:
      "A full-day immersive program covering the complete DIONavi full arch surgery workflow — from planning to execution. Dr. Mehdi Adibrad leads participants through lecture, live demonstration, and hands-on practice to build competency in guided full arch implant surgery using the DIONavi system.",
    highlights: [
      "Full arch implant surgery planning with DIONavi",
      "Live demonstration of the DIONavi guided surgery protocol",
      "Hands-on practice component",
      "7 CE credits for a full day of learning",
      "Collaborative session with EverSmiles and DIONavi specialists",
    ],
  },
  {
